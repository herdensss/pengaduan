...
<!--===============================================================================================-->	
	<link rel="icon" type="image/png" href="images/icons/lm.png"/>
<!--===============================================================================================-->
	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				<form method="post" action="{{ route('postRegister' )}}"class="login100-form validate-form" style="padding-top: 4vh">
					@include('alert')
					@csrf
					...
					<div class="wrap-input100 validate-input" data-validate="Buat Password">
				...
				<div class="login100-more" style="background-image: url('images/lamas.png');">
				</div>
			</div>
		</div>
	</div>
